...
class SpriteSheet:
    ...
    def load_grid_images(self, num_rows, num_cols, x_margin=0, x_padding=0,
        ...
        x_margin is space between left edge of sheet and left edge of first column.
        x_padding is space between columns.
        ...
        #   and the padding between each column, then divide by num_cols.
        # Same reasoning for y.
        ...
        for row_num in range(num_rows):
            for col_num in range(num_cols):
                ...
                #   and one padding size for each column. Same for y.
        ...
        print(f"Loaded {len(grid_images)} images from sprite sheet.")
